...
<div class="col-lg-12 stretch-card">
    <div class="card">
        <div class="card-body">
            <h1 class="card-title">Kết quả tìm kiếm sản phẩm</h1>
            <div>
                <?php 
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th style="font-weight: bold"> Danh mục sản phẩm </th>
              <th style="font-weight: bold"> Thương hiệu sản phẩm </th>
          ...
          <tbody>
            ...
            <tr class="table">
                    <th scope="row">{{$value_product->product_id}}</th>
                    <td>{{ $value_product->product_name }}</td>
                    <td>
                        <img src="public/upload/product/{{ $value_product->product_img }}" alt="Ảnh sản phẩm" style="width: 50px; height: 50px; object-fit: cover">
                    </td>
                    ...
                    <td>
                        ...
                        ?>
                            <a href="{{ URL::to('/active-product/'.$value_product->product_id)}}"><i class="mdi mdi-lock" style="color: red; font-size: 1.2rem"></i></a>
                        <?php  
                            }
                        ?>
                    </td>
