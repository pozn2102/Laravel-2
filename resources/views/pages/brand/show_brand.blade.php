...
<div class="fb-like" data-href="{{ $url_canonical }}" data-width="" data-layout="button_count" data-action="like" data-size="small" data-share="true"></div>
    <div class="features_items">
        @foreach ($brand_name as $key => $value_name)
            <h2 class="title text-center">{{$value_name->brand_name }}</h2>
        @endforeach
    ...
    <div class="fb-comments" data-href="http://localhost/MyProject/category?category_id=1" data-width="" data-numposts="20"></div>
</div>
@endsection