                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php 
									...
									if($customer_id!=NULL){
								?>
                                <li><a href="{{ URL::to('/logout-customer') }}"><i class="fa fa-lock"></i> Đăng
                                        xuất</a></li>
                                <?php 
									}else{
								?>
                                <li><a href="{{ URL::to('/login-customer') }}"><i class="fa fa-lock"></i> Đăng nhập</a>
                                </li>
                                <?php 
									}
								?>
                    ...
                    <div class="col-sm-4">
                        <form action="{{ URL::to('/search-product') }}" method="post">
                            ...
                            <div class="search_box pull-right">
                                <input type="text" name="keyword_submit" placeholder="Nhập sản phẩm" />
